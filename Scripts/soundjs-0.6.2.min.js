...
(), this.createjs = this.createjs || {}, function () {
	...
	b.createInstance = function (c, d, e) {
		...
		h = null;
	    return null != g && null != g.src ? (a.create(g.src), null == d && (d = c.startTime), h = b.activePlugin.create(g.src, d, e || c.duration), f = f || b._defaultPlayPropsHash[g.src], f && h.applyPlayProps(f)) : h = new createjs.DefaultSoundInstance(c, d, e),
...
(), this.createjs = this.createjs || {}, function () {
	...
	b._generateCapabilities = function () {
	    if (null == b._capabilities) {
			...
			"ontouchstart" in window && "running" != b.context.state && (b._unlock(), document.addEventListener("mousedown", b._unlock, !0), document.addEventListener("touchend", b._unlock, !0)),
			b._capabilities = {
			    panning: !0,
			    volume: !0,
			    tracks: -1
...
(), this.createjs = this.createjs || {}, function () {
	...
	b.get = function (a) {
	    var c = b._tags[a];
	    return null == c ? (c = b._tags[a] = b._tagPool.get(), c.src = a) : b._tagUsed[a] ? (c = b._tagPool.get(), c.src = a) : b._tagUsed[a] = !0,
		c
	},
	b.set = function (a, c) {
