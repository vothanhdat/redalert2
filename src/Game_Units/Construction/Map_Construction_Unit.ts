...
export const MAP_CONSTRUCTION_UNIT = {
    ...
    process_color_gl_done: function (textures, listresource) {
        ...
        on_texture_load_done("mapconstruction");
        //MAP_CONSTRUCTION_UNIT = null;
    }
}

export class Map_Construction_unit extends Construction_unit {
...
export class Map_Building_Construction_unit extends Map_Construction_unit {
...
export class Map_scrap extends Map_scrap_Base {
