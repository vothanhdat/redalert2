...
export class Plane_unit extends Flyable_Unit {
...
export class Plane_unit_failout extends Game_unit {
    /**
     *   @param {Plane_unit} ob
     * */
    constructor(ob) {
...
export class V3Rocket extends Flyable_Unit {
...
export class Rocker extends Flyable_Unit {
    constructor(x, y, z, team, property, enemy) {
        super(Math.round(x), Math.round(y), z, team, property);
        this.v = property.property.min_v * get_random(0.2);
        this.acceleration = property.property.acceleration * get_random(0.2);
