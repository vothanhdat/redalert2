...
import { USER_CONTROLER } from "../../Controler.js";
import { cloundcontainer, smokecontainer, smokecontainer2, stage, variouscontainer } from "../../Game_Container.js";
import { GRID } from "../GRID.js";
import { GAME_OBJECT, Game_object, check_available_screen, convert2screen, get_random } from "../Game_object.js";
import { Parachutist } from "../MoviableUnit/Flyable_Unit.js";
import { MOVEABLE_UNIT } from "../MoviableUnit/MoviableUnit.js";
...
var EFFECT = {
    ...
    load_texture_done: function (loader, resources) {
        ...
        LATE.on_texture_load_done("effect");
    }
}

class Game_Effect extends Game_object {


}


class Effect extends Game_Effect {
...
class Effect_with_smooke extends Effect {
...
class CloundParticle extends Game_Effect {
...
var Sprite_SmokeEffect_back = [];
var Sprite_SmokeEffect2_back = [];
...
class SmokeEffect extends Game_Effect {
    static process() {
...
class SmokeEffect2 extends Game_Effect {
    static process() {
...
class SmokeEffect2_supersort extends SmokeEffect2 {
    constructor(...args) {
        super(...args);
        this.r2 *= 10;
    }
...
class Light_Effect extends Game_Effect {
...
class Light_Effect_Autoscale extends Light_Effect {
...
class Repair_Effect extends Game_Effect {
    /**
...
class Parachutist_Sprite extends Game_Effect {
    /**
...
class Controler_Animation extends Game_Effect {
...
Object.assign(LATE, { EFFECT_FIRE_TYPE, EFFECT_TYPE, Effect, FireEffect, Game_Effect, Light_Effect, Light_Effect_Autoscale, Parachutist_Sprite, Repair_Effect, SmokeEffect, SmokeEffect2, SmokeEffect2_supersort });

export { CLOUND, CONTROLLER_ANIMATION, CloundParticle, CloundParticle_color, Controler_Animation, EFFECT, EFFECT_FIRE_TYPE, EFFECT_TYPE, Effect, Effect_with_smooke, FireEffect, Game_Effect, HIGH_PERFOMANCE_GET_SPRITE, HIGH_PERFOMANCE_REMOVE_SPRITE, HIGH_PERFOMANCE_REMOVE_SPRITE_IN_LOOP, Light_Effect, Light_Effect_Autoscale, Light_Effect_Autoscale_List, Parachutist_Sprite, Repair_Effect, SmokeEffect, SmokeEffect2, SmokeEffect2_supersort, Sprite_SmokeEffect2_back, Sprite_SmokeEffect_back, cloundbasetexture, cloundtexture, lighttexture, smooketexture };
