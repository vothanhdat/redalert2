...
import { GAME_OBJECT, Game_object, calcfar2, check_available_screen, convert2screen } from "../Game_object.js";
...
var MAP_OBJECT = {
    ...
    load_texture_done: function (loader, resources) {
        ...
        LATE.on_texture_load_done("map_ob");
    }
}


class Map_object extends Game_object {
...
class Heap_mine extends Map_object {
...
class Simple_map_object extends Map_object {
    constructor(x, y, z, property) {
        super(x, y, z, property);
...
Object.assign(LATE, { Grouph_mine, Heap_mine, MAP_OBJECT_TYPE, Map_object, Mine, Tree });

export { Grouph_mine, Heap_mine, MAP_OBJECT, MAP_OBJECT_TYPE, Map_object, Mine, Simple_map_object, Tree };
