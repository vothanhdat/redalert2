...
import { GAME_OBJECT, calcfar2, calcfar2_full, checkcircle } from "../Game_object.js";
...
class Movealbe_unit extends Game_unit {

};


class Ground_moveable_unit extends Movealbe_unit {
    ...
    process_clean_arear(time) {
        ...
        if (performance.now() - this.group_protect._time_ > 700 / SPEED) {
            ...
            if (list.length > 0) {
                this.group_protect.listgoal = list.filter(e => (e.property.name != "veh_ore_allied") && !(e instanceof LATE.Flyable_Unit));
...
Object.assign(LATE, { Ground_moveable_unit, Movealbe_unit });

export { Ground_moveable_unit, MOVEABLE_UNIT, Movealbe_unit };
