...
import { TEAM, USER_CONTROLER } from "../../../Controler.js";
import { stage } from "../../../Game_Container.js";
import { Construction_unit, Defender_Construction_unit } from "../../Construction/Construction_Unit.js";
import { GRID } from "../../GRID.js";
import { GAME_OBJECT, calcfar, calcfar2, calcfar2_full, check_available_screen, checkcircle } from "../../Game_object.js";
import { MOVEABLE_UNIT, Movealbe_unit } from "../MoviableUnit.js";
import { Solider_unit } from "./Solider_Unit.js";
    ...
    class: class extends Solider_unit {
        ...
        fire() {
            if (this.state == STATE.FIX || this.state == STATE.ATTACK_FIX) {
                ...
                this.enemy && GAME_OBJECT.add_instance(new LATE.Weapon(this, this.enemy, LATE.ATTACK_TYPE[this.property.property.attack_type_fix]));
            } else {
                super.fire();
            }
        }
...
SOLIDER_TYPE.sol_flakt_allied = {
    ...
    class: class extends Solider_unit {
        filter_enemy(ob) {
            if (ob instanceof LATE.VEHICLE_TYPE.veh_ore_allied.class)
...
SOLIDER_TYPE.sol_ivan_soviet = {
    ...
    class: class extends Solider_unit {
        fire() {
            if (this.enemy) {
                GAME_OBJECT.add_instance(new LATE.Weapon(this, this.enemy, LATE.ATTACK_TYPE[this.property.property.attack_type_1]));
                this.delete();
            }
        }
        on_destroy(attackobject) {
            GAME_OBJECT.add_instance(new LATE.Weapon(this, this, LATE.ATTACK_TYPE[this.property.property.attack_type_1]));
...
Object.assign(LATE, { SOLIDER_TYPE });

export { SOLIDER_AUDIO_TYPE, SOLIDER_TYPE };
