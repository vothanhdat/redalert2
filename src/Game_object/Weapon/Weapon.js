...
import { Game_object, convert2screen } from "../Game_object.js";
...
class Game_weapon extends Game_object {

}


class Weapon extends Game_weapon {
...
Object.assign(LATE, { Game_weapon, WEAPON, Weapon, createline2 });

export { Game_weapon, WEAPON, Weapon, createline, createline2, linetexture, linetexture_rgb, linetexture_simple, updateline };
