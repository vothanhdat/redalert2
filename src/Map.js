...
import { mainstage, stage } from "./Game_Container.js";
import { renderer } from "./core/renderer.js";
import { display_height, display_width, screen_h, screen_w, screen_x, screen_y, set_max_x, set_max_y } from "./core/state.js";
import { random } from "./lib/JavaScript_helper.js";
...
function Map(mapname) {
    ...
    var initmapgraphich2 = function (map, loader, resources) {
        ...
        LATE.FOG_GRAPGICH.setmap(map);
        LATE.on_texture_load_done();
    }
        ...
        $.getJSON("/Data/map/map.json", function (result) {
            ...
            var loadmapdatadone = function () {
                loadmapdatadone = function (mapobject, mapgroundtable) {
                    ...
                    set_max_x(mapobject.maxx / 2);
                    set_max_y(mapobject.maxy / 2);
...
export { MAP_TEST_DEEP, MAP_TEST_DEEP2, Map };
